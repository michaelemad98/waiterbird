...
class Order_container extends StatelessWidget {
  ...
  Order_container({Key? key,this.itemname,this.itemprice,this.image,this.onPresseddelete,this.onPressedrmv,this.onPressedadd,this.qty}) : super(key: key);
      ...
      children: [
        Container(
          ...
          child:Row(
            ...
            children: [
              FadeInImage.assetNetwork(placeholder: 'assets/images/anim.gif', image: '${image}',
                width: width/8,
                height:height/8 ,
              ),
              Column(
